        ...
        <div className="space-y-8">
            ...
            <div className="space-y-6">
                {bookings.map(booking => (
                    <div key={booking.booking_id} className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                        ...
                        <div className="pt-4 mt-4 border-t border-gray-200 flex flex-wrap justify-between items-center gap-4">
                            <div>
