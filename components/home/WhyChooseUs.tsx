    ...
    return (
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="animate-fade-in-down opacity-0" style={{ animationDelay: '100ms' }}>
                    <FeatureCard 
                ...
                <div className="animate-fade-in-down opacity-0" style={{ animationDelay: '200ms' }}>
                    <FeatureCard 
                ...
                <div className="animate-fade-in-down opacity-0" style={{ animationDelay: '300ms' }}>
                    <FeatureCard 
